...
// consume code
var Influence_Learning_Enable = false
...
type Prog struct {
	...
	// Minimize Optimization vars for dynamic influence learning
	Influence_Hash_NeedUpdate bool
	Minimize_ExecuteStatus    bool
	Minimize_CallsCovHash     [MaxCalls]uint32
}
