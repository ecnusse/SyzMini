...
type RPCManagerView interface {
	...
	// consume code
	updateInfluence(InfluenceMatrix [][]uint8)
}
...
// consume code
func (serv *RPCServer) InfluenceUpdate(a *rpctype.InfluenceArgs, r *int) error {
	serv.mgr.updateInfluence(a.InfluenceMatrix)
	return nil
}
